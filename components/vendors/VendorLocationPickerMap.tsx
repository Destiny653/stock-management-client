...
export default function VendorLocationPickerMap({
    ...
    if (!isLoaded) {
        return (
            <div className="h-48 rounded-md border border-slate-200 flex items-center justify-center bg-slate-50">
    ...
    return (
        <div className="space-y-2">
            ...
            {/* Map */}
            <div className="h-48 rounded-md overflow-hidden border border-slate-200">
                <GoogleMap
            ...
            {/* Coordinates Display */}
            {position && (
                <div className="flex items-center gap-4 text-sm text-slate-600 bg-slate-50 rounded-md p-3">
